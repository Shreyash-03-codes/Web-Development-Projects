...
<head>
  ...
  <title>Library Management System | Delete Book</title>
  ...
  <div class="row">
    ...
    <nav class="col-md-3 min-vh-100 col-lg-2 bg-dark text-white p-3">
      ...
      <ul class="nav flex-column">
			        ...
			        <li class="nav-item mt-3">
			          <a class=" btn btn-block btn-primary" href="updatebook">Update Book</a>
			        </li>
			        <li class="nav-item mt-3">
				  ...
				  <tbody>
				    <c:forEach var="book" items="${books}">
				      <tr>
				        ...
				        <td><a href="deletedbook/${book.id }"><i class="fa-solid fa-trash"></i></a></td>
				      </tr>
				    </c:forEach>
				  </tbody>
				</table>
