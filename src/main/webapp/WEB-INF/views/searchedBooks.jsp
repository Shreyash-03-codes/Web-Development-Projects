...
<head>
  ...
  <title>Library Management System | Searched Books</title>
  ...
  <div class="row">
    ...
    <nav class="col-md-3 min-vh-100 col-lg-2 bg-dark text-white p-3">
      ...
      <ul class="nav flex-column">
			        ...
			        <li class="nav-item mt-3">
			          <a class=" btn btn-block btn-info" href="allbooks">Search Book</a>
			        </li>
      ...
      <div class="container card bg-secondary ">
      	...
      	<div class="row">
      		...
      		<div class="offset-1 col-10 text-light p-3">
      			<h2 class="text-light">Searched Books <i class="fas fa-book ml-2"></i></h2>
